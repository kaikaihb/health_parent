    ...
    methods: {
        ...
        handleOrderSet(day) {
            this.$prompt('请输入可预约人数', '预约设置', {
                ...
                axios.post('/health_web/ordersetting/editNumberByDate.do',
                    {
                    ...
                    if (response.data.flag){
                        //再将页面填充一次
                        this.initData(this.formatDate(this.currentYear, this.currentMonth + 1, 1));
        ...
        initData: function (cur) {
            ...
            axios.post(
                '/health_web/ordersetting/getOrderSettingByMonth.do?date=' + this.currentYear + '-' + this.currentMonth
            ).then((response) => {
                if (response.data.flag) {
